...
Age and previous cholecystectomy also influence caliber. The review by [Lucius and colleagues](https://doi.org/10.3390/diagnostics15070919) documents variation across measurement techniques and patient groups. I would not treat an age-adjusted or postoperative reference range as permission to ignore new symptoms or a changing duct.
...
The [ACR jaundice guidance](https://pubmed.ncbi.nlm.nih.gov/31054739/) organizes imaging around the suspected mechanism. Ultrasound is useful for an initial assessment of duct dilatation, gallstones, and liver abnormalities. However, an examination aimed at explaining jaundice must consider processes that do not mechanically obstruct a duct.
...
A dark filling defect on MRCP is not automatically a stone. Air, debris, flow effects, and reconstruction artifacts can mimic pathology. Maximum-intensity projections may obscure a small defect, so source images matter. [Griffin, Charles-Edwards, and Grant](https://pubmed.ncbi.nlm.nih.gov/22695995/) describe these interpretation pitfalls.
...
- Hindman et al., [ACR Appropriateness Criteria: Jaundice](https://pubmed.ncbi.nlm.nih.gov/31054739/), Journal of the American College of Radiology 2019.
...
- Vardar et al., [Ultrasonographic evaluation of patients with abnormal liver function tests in the emergency department](https://pubmed.ncbi.nlm.nih.gov/35026887/), Ultrasonography 2022.
